...
//React prevents reload by stopping the browser’s default navigation, updating the URL using the History API, and re-rendering UI components within the same HTML document.
